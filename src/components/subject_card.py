...
def subject_card(name, code, section, stats=None, footer_callback=None):
    # Keep HTML unindented inside multi-line strings to prevent Markdown code block formatting
...
Code : <span style="background: #E0E3FF; color: #5865F2; padding: 8px 12px; border-radius: 5px;">{code}</span> | Section : {section}
</p>"""
